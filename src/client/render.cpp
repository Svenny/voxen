...
Render::Render(os::GlfwWindow &window, svc::ServiceLocator &svc) : m_window(window)
{
	if (!vulkan::Backend::backend().start(m_window, svc)) {
...
void Render::drawFrame(const world::State &world_state, const GameView &view)
{
