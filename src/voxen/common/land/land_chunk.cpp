...
void Chunk::setAllBlocks(const BlockIdStorage::ExpandedArray &array)
{
	m_block_ids = BlockIdStorage(array);
}

void Chunk::setAllBlocksUniform(uint16_t value)
{
	m_block_ids.setUniform(value);
}

void ChunkAdjacencyRef::expandBlockIds(CubeArrayView<uint16_t, SIZE> view) const
{
