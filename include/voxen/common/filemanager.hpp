...
public:
	...
	static bool writeUserTextFile(const std::filesystem::path& relative_path, const std::string& text, bool create_directories = true) noexcept;
	...
	static std::future<std::optional<extras::dyn_array<std::byte>>> readUserFileAsync(std::filesystem::path relative_path) noexcept;
	static std::future<bool> writeUserFileAsync(std::filesystem::path relative_path, const void *data, size_t size, bool create_directories = true) noexcept;
	static std::future<std::optional<std::string>> readUserTextFileAsync(std::filesystem::path relative_path) noexcept;
	static std::future<bool> writeUserTextFileAsync(std::filesystem::path relative_path, const std::string&& text, bool create_directories = true) noexcept;

	static std::future<std::optional<extras::dyn_array<std::byte>>> readFileAsync(std::filesystem::path relative_path) noexcept;
